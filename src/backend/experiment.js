import { getRandBit, getRandPolarizer } from "./random";
import { prepare_qubit, measure_qubit } from "./qubit";
...
const experiment_with_eve = () => {
  ...
  if (alice_basis == bob_basis)
    return {
      aliceBit: alice_bit,
      bobBit: bob_bit,
      eveBit: eve_bit, // eve is active
      validKeyBit: true, // indicate similar bases
